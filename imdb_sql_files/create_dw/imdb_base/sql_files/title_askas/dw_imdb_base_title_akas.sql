...
CREATE TABLE DW_IMDB_BASE_TITLE_AKAS (
	...
	,TITLEID_NK TEXT NOT NULL -- A TCONST, AN ALPHANUMERIC UNIQUE IDENTIFIER OF THE TITLE
  ...
  ,PRIMARY KEY (P_TITLE_ID)
	...
	CREATE INDEX DW_IMDB_BASE_TITLE_AKAS_INDX ON DW_IMDB_BASE_TITLE_AKAS (TITLEID_NK,ORDERING_NK);

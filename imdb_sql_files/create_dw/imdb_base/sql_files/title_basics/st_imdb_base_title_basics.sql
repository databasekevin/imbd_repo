...
CREATE TABLE ST_IMDB_BASE_TITLE_BASICS (
	...
	,TITLETYPE_NK TEXT NOT NULL -- THE TYPE/FORMAT OF THE TITLE (E.G. MOVIE, SHORT, TVSERIES, TVEPISODE, VIDEO, ETC)
	,PRIMARYTITLE_DESC TEXT NOT NULL -- THE MORE POPULAR TITLE / THE TITLE USED BY THE FILMMAKERS ON PROMOTIONAL MATERIALS AT THE POINT OF RELEASE
	,ORIGINALTITLE_DESC TEXT NOT NULL -- ORIGINAL TITLE, IN THE ORIGINAL LANGUAGE
